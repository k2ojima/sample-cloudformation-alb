...
class UpdateStackCommand extends Command
{
    ...
    protected static $defaultName = 'stack:update';
    ...
    {
        $this->setDescription('CloudFormationスタックを更新します');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $output->writeln("<info>Starting to update $target stack..</info>");
